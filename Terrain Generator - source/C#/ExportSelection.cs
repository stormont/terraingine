...
{
	/// <summary>
	/// A Form for selected which export method to save terrain with.
	/// </summary>
	public class ExportSelection : System.Windows.Forms.Form
	{
		#region Data Members
		...
		#region Properties
		/// <summary>
		/// Gets the selected export method.
		/// </summary>
		public int ExportMethod
		{
		...
		#region Methods
		/// <summary>
		/// Creates an export selection form.
		/// </summary>
		...
		/// <summary>
		/// Selects the double-clicked export method.
		/// </summary>
		...
		/// <summary>
		/// Selects an export method and enables the "OK" button.
		/// </summary>
		...
		/// <summary>
		/// Loads the export methods from which the user will choose from.
		/// </summary>
		/// <param name="methods">The list of export methods.</param>
		public void LoadExportNames( string[] methods )
		{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Select a method by which to export terrain:";
			// 
			// lstMethods
			// 
			...
			this.Text = "Select Export Method";
