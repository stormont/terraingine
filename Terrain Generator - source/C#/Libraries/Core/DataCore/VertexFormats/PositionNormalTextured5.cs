...
namespace Voyage.Terraingine.DataCore.VertexFormats
{
	...
	/// Also contains information for five sets of texture coordinates.
	/// </summary>
	public struct PositionNormalTextured5
	{
		#region Data Members
		/// <summary>
		...
		public static readonly D3D.VertexFormats Format =
			D3D.VertexFormats.Position | D3D.VertexFormats.Normal | D3D.VertexFormats.Texture5;
		
		/// <summary>
		/// Stride size of the Direct3D vertex.
		/// </summary>
		public static readonly int StrideSize = DXHelp.GetTypeSize( typeof( PositionNormalTextured5 ) );
		
		/// <summary>
		/// Number of textures the vertex can hold.
		/// </summary>
		public static readonly int numTextures = 5;
		#endregion
		...
		#region Methods
		/// <summary>
		/// Creates a vertex with a position, a vertex normal, and five sets of texture coordinates.
		/// </summary>
		...
		public PositionNormalTextured5( float x, float y, float z, float nX, float nY, float nZ,
		...
		public PositionNormalTextured5( Vector3 position, Vector3 normal, Vector2 texCoords1,
