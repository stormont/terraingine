...
namespace Voyage.Terraingine.DataCore.VertexFormats
{
	...
	/// Also contains information for three sets of texture coordinates.
	/// </summary>
	public struct PositionNormalTextured3
	{
		#region Data Members
		/// <summary>
		...
		public static readonly D3D.VertexFormats Format =
			D3D.VertexFormats.Position | D3D.VertexFormats.Normal | D3D.VertexFormats.Texture3;
		
		/// <summary>
		/// Stride size of the Direct3D vertex.
		/// </summary>
		public static readonly int StrideSize = DXHelp.GetTypeSize( typeof( PositionNormalTextured3 ) );
		
		/// <summary>
		/// Number of textures the vertex can hold.
		/// </summary>
		public static readonly int numTextures = 3;
		#endregion
		...
		#region Methods
		/// <summary>
		/// Creates a vertex with a position, a vertex normal, and three sets of texture coordinates.
		/// </summary>
		...
		public PositionNormalTextured3( float x, float y, float z, float nX, float nY, float nZ,
		...
		public PositionNormalTextured3( Vector3 position, Vector3 normal, Vector2 texCoords1,
			Vector2 texCoords2, Vector2 texCoords3 )
		{
			X = position.X;
			Y = position.Y;
			Z = position.Z;
