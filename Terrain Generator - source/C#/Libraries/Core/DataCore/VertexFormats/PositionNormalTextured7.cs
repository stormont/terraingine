...
namespace Voyage.Terraingine.DataCore.VertexFormats
{
	...
	/// Also contains information for seven sets of texture coordinates.
	/// </summary>
	public struct PositionNormalTextured7
	{
		#region Data Members
		/// <summary>
		...
		public static readonly D3D.VertexFormats Format =
			D3D.VertexFormats.Position | D3D.VertexFormats.Normal | D3D.VertexFormats.Texture7;
		
		/// <summary>
		/// Stride size of the Direct3D vertex.
		/// </summary>
		public static readonly int StrideSize = DXHelp.GetTypeSize( typeof( PositionNormalTextured7 ) );
		
		/// <summary>
		/// Number of textures the vertex can hold.
		/// </summary>
		public static readonly int numTextures = 7;
		#endregion
		...
		#region Methods
		/// <summary>
		/// Creates a vertex with a position, a vertex normal, and seven sets of texture coordinates.
		/// </summary>
		...
		public PositionNormalTextured7( float x, float y, float z, float nX, float nY, float nZ,
			float u1, float v1, float u2, float v2, float u3, float v3, float u4, float v4,
			float u5, float v5, float u6, float v6, float u7, float v7 )
		{
			X = x;
			Y = y;
			Z = z;
		...
		public PositionNormalTextured7( Vector3 position, Vector3 normal, Vector2 texCoords1,
