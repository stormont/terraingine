...
namespace Voyage.Terraingine.DataCore.VertexFormats
{
	...
	/// Also contains information for six sets of texture coordinates.
	/// </summary>
	public struct PositionNormalTextured6
	{
		#region Data Members
		/// <summary>
		...
		public static readonly D3D.VertexFormats Format =
			D3D.VertexFormats.Position | D3D.VertexFormats.Normal | D3D.VertexFormats.Texture6;
		
		/// <summary>
		/// Stride size of the Direct3D vertex.
		/// </summary>
		public static readonly int StrideSize = DXHelp.GetTypeSize( typeof( PositionNormalTextured6 ) );
		
		/// <summary>
		/// Number of textures the vertex can hold.
		/// </summary>
		public static readonly int numTextures = 6;
		#endregion
		...
		#region Methods
		/// <summary>
		/// Creates a vertex with a position, a vertex normal, and six sets of texture coordinates.
		/// </summary>
		...
		public PositionNormalTextured6( float x, float y, float z, float nX, float nY, float nZ,
			float u1, float v1, float u2, float v2, float u3, float v3, float u4, float v4,
			float u5, float v5, float u6, float v6 )
		{
			X = x;
			Y = y;
			Z = z;
		...
		public PositionNormalTextured6( Vector3 position, Vector3 normal, Vector2 texCoords1,
			Vector2 texCoords2, Vector2 texCoords3, Vector2 texCoords4,
			Vector2 texCoords5, Vector2 texCoords6 )
		{
			X = position.X;
			Y = position.Y;
			Z = position.Z;
